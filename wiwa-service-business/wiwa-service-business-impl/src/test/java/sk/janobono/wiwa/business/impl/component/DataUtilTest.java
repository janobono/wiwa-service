...
class DataUtilTest {
    ...
    void partChangeDataTest() {
        PartData part = PartBasicData.builder()
                ...
                .edgeIdB1(1L)
                .edgeIdB2(1L)
                .dimensions(new DimensionsData(BigDecimal.valueOf(250), BigDecimal.valueOf(400)))
        ...
        part = PartDuplicatedBasicData.builder()
                ...
                .edgeIdB1(3L)
                .edgeIdB2(3L)
                .dimensions(new DimensionsData(BigDecimal.valueOf(345), BigDecimal.valueOf(450)))
        ...
        part = PartFrameData.builder()
                ...
                .edgeIdB2(1L)
                .edgeIdB2I(1L)
                .dimensions(new DimensionsData(BigDecimal.valueOf(400), BigDecimal.valueOf(400)))
