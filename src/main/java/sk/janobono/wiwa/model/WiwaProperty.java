...
public enum WiwaProperty implements ApplicationPropertyKey {
    ...
    PRODUCT_BOARD_CATEGORY_ITEM("PRODUCT", "BOARD_CATEGORY_ITEM"),
    PRODUCT_BOARD_SEARCH_CATEGORIES("PRODUCT", "BOARD_SEARCH_CATEGORIES"),
    PRODUCT_EDGE_CATEGORY_ITEM("PRODUCT", "EDGE_CATEGORY_ITEM"),
    PRODUCT_EDGE_SEARCH_CATEGORIES("PRODUCT", "EDGE_SEARCH_CATEGORIES"),
    PRODUCT_FREE_SALE_CATEGORY_ITEM("PRODUCT", "FREE_SALE_CATEGORY_ITEM"),
    PRODUCT_FREE_SALE_SEARCH_CATEGORIES("PRODUCT", "FREE_SALE_SEARCH_CATEGORIES");
