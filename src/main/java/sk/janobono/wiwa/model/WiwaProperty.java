...
public enum WiwaProperty implements ApplicationPropertyKey {
    ...
    PRODUCT_BOARD_CATEGORY_ID("PRODUCT", "BOARD_CATEGORY_ID"),
    PRODUCT_EDGE_CATEGORY_ID("PRODUCT", "EDGE_CATEGORY_ID"),
    PRODUCT_SERVICE_CATEGORY_ID("PRODUCT", "SERVICE_CATEGORY_ID"),
