...
public class IndexController {
    ...
    @PostMapping("/title")
    @PreAuthorize("hasAnyAuthority('w-admin', 'w-manager')")
    public LocalizedDataSo<String> setTitle(@RequestBody final LocalizedDataSo<String> data) {
    ...
    @PreAuthorize("hasAnyAuthority('w-admin', 'w-manager')")
    public LocalizedDataSo<String> setWelcomeText(@RequestBody final LocalizedDataSo<String> data) {
    ...
    public LocalizedDataSo<ApplicationInfoSo> setApplicationInfo(
            @Valid @RequestBody final LocalizedDataSo<ApplicationInfoSo> data) {
    ...
    @PreAuthorize("hasAnyAuthority('w-admin', 'w-manager')")
    public LocalizedDataSo<CompanyInfoSo> setCompanyInfo(@Valid @RequestBody final LocalizedDataSo<CompanyInfoSo> data) {
    ...
    @PreAuthorize("hasAnyAuthority('w-admin', 'w-manager')")
    public LocalizedDataSo<String> setCookiesInfo(@RequestBody final LocalizedDataSo<String> data) {
    ...
    @PreAuthorize("hasAnyAuthority('w-admin', 'w-manager')")
    public LocalizedDataSo<String> setGdprInfo(@RequestBody final LocalizedDataSo<String> data) {
    ...
    @PreAuthorize("hasAnyAuthority('w-admin', 'w-manager')")
    public LocalizedDataSo<String> setWorkingHours(@RequestBody final LocalizedDataSo<String> data) {
